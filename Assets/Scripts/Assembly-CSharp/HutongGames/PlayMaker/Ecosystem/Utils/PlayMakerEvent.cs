...
namespace HutongGames.PlayMaker.Ecosystem.Utils
{
	...
	public class PlayMakerEvent
	{
		...
		public bool SendEvent(PlayMakerFSM fromFsm, PlayMakerTimelineEventTarget eventTarget, bool debug = false)
		{
			...
			if (debug)
			{
				Debug.Log(string.Concat("Sending event <", eventName, "> from fsm:", fromFsm.FsmName, " ", eventTarget.eventTarget, " ", eventTarget.gameObject, " ", eventTarget.fsmComponent));
			}
		...
		public override string ToString()
		{
			...
			return string.Format("PlayMaker Event : {0}", arg);
		}
	}
}
