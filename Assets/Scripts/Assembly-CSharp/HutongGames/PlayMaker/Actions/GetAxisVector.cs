...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class GetAxisVector : FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			float num = ((!horizontalAxis.IsNone && !string.IsNullOrEmpty(horizontalAxis.Value)) ? Input.GetAxis(horizontalAxis.Value) : 0f);
			float num2 = ((!verticalAxis.IsNone && !string.IsNullOrEmpty(verticalAxis.Value)) ? Input.GetAxis(verticalAxis.Value) : 0f);
