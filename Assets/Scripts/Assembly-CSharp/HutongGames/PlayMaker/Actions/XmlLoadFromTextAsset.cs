...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class XmlLoadFromTextAsset : DataMakerXmlNodeActions
	{
		...
		private void LoadFromText()
		{
			...
			DataMakerXmlProxy dataMakerXmlProxy = DataMakerCore.GetDataMakerProxyPointer(typeof(DataMakerXmlProxy), ownerDefaultTarget, reference.Value, false) as DataMakerXmlProxy;
