...
namespace Com.LuisPedroFonseca.ProCamera2D
{
	...
	public class ProCamera2DNumericBoundaries : BasePC2D, IPositionDeltaChanger, ISizeOverrider
	{
		...
		public Vector3 AdjustDelta(float deltaTime, Vector3 originalDelta)
		{
			...
			float num5 = ((!UseSoftBoundaries) ? 0f : (base.ProCamera2D.ScreenSizeInWorldCoordinates.x * SoftAreaSize));
			float num6 = ((!UseSoftBoundaries) ? 0f : (base.ProCamera2D.ScreenSizeInWorldCoordinates.y * SoftAreaSize));
