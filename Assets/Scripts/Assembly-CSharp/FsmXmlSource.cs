...
public class FsmXmlSource : FsmStateAction
{
	...
	public XmlNode Value
	{
		get
		{
			...
			case 3:
			{
				DataMakerXmlProxy dataMakerXmlProxy = DataMakerCore.GetDataMakerProxyPointer(typeof(DataMakerXmlProxy), sourceProxyGameObject.Value, sourceProxyReference.Value, false) as DataMakerXmlProxy;
