...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenRectTransformJumpAnchorPos : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			sequence.Append(base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOJumpAnchorPos(to.Value, jumpPower.Value, numJumps.Value, duration.Value, snapping.Value)
			...
			if (debugThis.Value)
			{
				Debug.Log("GameObject [" + base.State.Fsm.GameObjectName + "] FSM [" + base.State.Fsm.Name + "] State [" + base.State.Name + "] - DOTween RectTransform Jump Anchor Pos - SUCCESS!");
			}
			if (finishImmediately.Value)
			{
				Finish();
