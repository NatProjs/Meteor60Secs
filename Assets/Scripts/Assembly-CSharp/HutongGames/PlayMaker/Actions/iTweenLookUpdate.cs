...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class iTweenLookUpdate : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			{
				hash.Add("looktarget", (!vectorTarget.IsNone) ? vectorTarget.Value : Vector3.zero);
			}
			...
			hash.Add("axis", (axis != 0) ? Enum.GetName(typeof(iTweenFsmAction.AxisRestriction), axis) : string.Empty);
			DoiTween();
		}
