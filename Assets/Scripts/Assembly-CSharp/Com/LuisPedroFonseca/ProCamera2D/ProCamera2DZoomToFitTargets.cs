...
namespace Com.LuisPedroFonseca.ProCamera2D
{
	...
	public class ProCamera2DZoomToFitTargets : BasePC2D, ISizeOverrider
	{
		...
		public float OverrideSize(float deltaTime, float originalSize)
		{
			...
			return _targetCamSizeSmoothed = Mathf.SmoothDamp(_targetCamSizeSmoothed, _targetCamSize, ref _zoomVelocity, (!(_targetCamSize < _targetCamSizeSmoothed)) ? ZoomOutSmoothness : ZoomInSmoothness, float.MaxValue, deltaTime);
		}
