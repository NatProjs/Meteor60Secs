...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DOTweenImageColor : FsmStateAction
	{
		...
		{
			tweener = base.Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Image>().DOColor(to.Value, duration.Value);
			...
			if (debugThis.Value)
			{
				Debug.Log("GameObject [" + base.State.Fsm.GameObjectName + "] FSM [" + base.State.Fsm.Name + "] State [" + base.State.Name + "] - DOTween Image Color - SUCCESS!");
			}
			if (finishImmediately.Value)
			{
				Finish();
